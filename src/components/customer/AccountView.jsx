    ...
    <div style={{ padding:'20px 16px' }}>
      ...
      {!loading && orders.length === 0 && (
        <div style={{ textAlign:'center', padding:'40px 0' }}>
          ...
          <div style={{ fontFamily:'DM Serif Display,serif', fontSize:20, color:C.text, marginBottom:8 }}>No orders yet</div>
...
function MyDetails({ onBack }) {
  ...
  return (
    <div style={{ padding:'20px 16px' }}>
      <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:20 }}>
        <button onClick={onBack} style={{ background:'none', border:'none', color:C.muted, cursor:'pointer', fontSize:20, padding:0 }}>←</button>
        <div style={{ fontFamily:'DM Serif Display,serif', fontSize:22, color:C.text }}>My Details</div>
      </div>
...
function MyCredit({ onBack }) {
  ...
  return (
    <div style={{ padding:'20px 16px' }}>
      <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:20 }}>
        <button onClick={onBack} style={{ background:'none', border:'none', color:C.muted, cursor:'pointer', fontSize:20, padding:0 }}>←</button>
        <div style={{ fontFamily:'DM Serif Display,serif', fontSize:22, color:C.text }}>My Credit</div>
      </div>
      ...
      <div style={{ background:'rgba(255,255,255,0.04)', borderRadius:12, padding:'14px 16px', marginBottom:16 }}>
        <div style={{ fontSize:13, fontWeight:500, color:C.text, marginBottom:8, fontFamily:'DM Sans,sans-serif' }}>How credit works</div>
      ...
      {user ? (
        <>
          ...
          <div onClick={signOut}
            ...
            <span style={{ fontSize:18 }}>🚪</span>
            <span style={{ fontSize:14, color:'#E8A070', fontFamily:'DM Sans,sans-serif' }}>Sign out</span>
          </div>
        </>
      ) : (
        <>
          {showAuth
            ...
            : <>
                <div style={{ textAlign:'center', padding:'30px 0 20px' }}>
                  ...
                  <div style={{ fontFamily:'DM Serif Display,serif', fontSize:22, color:C.text, marginBottom:8 }}>Your account</div>
