...
const SERVICES = [
  ...
  // ── CLUBS 2025 ──────────────────────────────────────────────
  { id:'club-001', category:'clubs', name:'Pacha Ibiza — Entry', subtitle:'The original icon · Ibiza Town', price:110, unit:'per person'||'per person', emoji:'🍒', partner:'Pacha Ibiza', location:'Passeig de Joan Carles I, Ibiza Town', lat:38.9054, lng:1.4380, highlights:['Ibiza institution since 1973','World-class DJ residencies','Multiple rooms','VIP tables available'], popular:true, duration:'All night', openingHours:'midnight-06:00', bookingTimes:['23:00', '00:00', '01:00', '02:00', '03:00'], minGuests:1, maxGuests:20, insider_tip:'Arrive after 1am when the energy peaks. Fridays are legendary for house music.' },
  { id:'club-002', category:'clubs', name:'Ushuaia — Open-air Show', subtitle:'Open-air superclub · Playa den Bossa', price:143, unit:'per person'||'per person', emoji:'🌴', partner:'Ushuaia Entertainment', location:"Playa d'en Bossa, Sant Josep", lat:38.8837, lng:1.4012, highlights:["World's biggest open-air club",'Giant pool stage','David Guetta residency','Calvin Harris & more'], popular:true, duration:'Evening show', openingHours:'18:00-00:00', bookingTimes:['17:00', '18:00', '19:00', '20:00', '21:00'], minGuests:1, maxGuests:20, insider_tip:'Shows run 4pm-midnight. Buy in advance — sells out weeks ahead.' },
  { id:'club-003', category:'clubs', name:'Hi Ibiza — Entry Ticket', subtitle:'Most modern superclub · Playa den Bossa', price:99, unit:'per person'||'per person', emoji:'⚡', partner:'Hi Ibiza', location:"Platja d'en Bossa, Sant Josep", lat:38.8831, lng:1.4008, highlights:['LED light art installation','Theatre & Club rooms','Best sound system on island','Top 10 world club'], popular:true, duration:'All night', openingHours:'midnight-06:00', bookingTimes:['23:00', '00:00', '01:00', '02:00', '03:00'], minGuests:1, maxGuests:20, insider_tip:'The Club room has the best production. Arrive before 2am.' },
  { id:'club-004', category:'clubs', name:'Amnesia Ibiza — Entry', subtitle:'Legendary superclub · San Rafael', price:88, unit:'per person'||'per person', emoji:'🎊', partner:'Amnesia', location:'Ctra. Ibiza a San Antonio, San Rafael', lat:38.9390, lng:1.3960, highlights:['Iconic Foam Party','Two massive dance floors','Terrace & Club Room','Techno & house legends'], popular:true, duration:'All night', openingHours:'midnight-06:00', bookingTimes:['23:00', '00:00', '01:00', '02:00', '03:00'], minGuests:1, maxGuests:20, insider_tip:'The Terrace room is the soul of Amnesia. Foam parties on Tuesdays are unmissable.' },
  { id:'club-005', category:'clubs', name:'DC-10 — Entry Ticket', subtitle:'Underground legend · Airport road', price:60, unit:'per person'||'per person', emoji:'✈️', partner:'DC-10', location:'Cami de sa Fita, Sant Josep', lat:38.8920, lng:1.3760, highlights:['The original underground club','Circoloco Mondays','Terrace under the planes','Techno & deep house'], popular:true, duration:'All night', openingHours:'15:00-23:00 Mon/Fri', bookingTimes:['14:00', '15:00', '16:00', '17:00', '18:00'], minGuests:1, maxGuests:10, insider_tip:'Circoloco on Mondays is the most legendary party in Ibiza.' },
  { id:'club-006', category:'clubs', name:'UNVRS Ibiza — Entry', subtitle:'New hyperclub 10000 capacity · San Rafael', price:80, unit:'per person'||'per person', emoji:'🛸', partner:'UNVRS', location:'Urbanizacion San Rafael, Ibiza', lat:38.9380, lng:1.3970, highlights:['10000 capacity hyperclub','Futuristic light tunnel','Built on old Privilege site','Grand opening 2025'], popular:true, duration:'All night', openingHours:'midnight-06:00', bookingTimes:['23:00', '00:00', '01:00', '02:00', '03:00'], minGuests:1, maxGuests:20, insider_tip:'The biggest club on the island. VIP tickets at 500 include full table service.' },
  { id:'club-007', category:'clubs', name:'Cova Santa — Dinner & Party', subtitle:'Natural cave venue · San Jose hills', price:130, unit:'per person'||'per person', emoji:'🌿', partner:'Cova Santa', location:'Ctra San Jose, Ibiza', lat:38.9120, lng:1.3560, highlights:['Natural cave setting','Elevated dinner show','Outdoor party under stars','Completely unique venue'], popular:true, duration:'Evening', openingHours:'19:00-02:00', bookingTimes:['19:00', '20:00', '21:00', '22:00', '23:00'], minGuests:2, maxGuests:10, insider_tip:'Start with dinner in the cave, stay for the party outside. Unlike anything else in Ibiza.' },
  { id:'club-008', category:'clubs', name:'Lio Ibiza — Cabaret Show', subtitle:'Upscale cabaret · Ibiza Town marina', price:200, unit:'per person'||'per person', emoji:'🎭', partner:'Lio', location:'Marina Botafoch, Ibiza Town', lat:38.9060, lng:1.4400, highlights:['Spectacular marina views','Acrobatic cabaret show','Dress code enforced','Most glamorous night out'], popular:true, duration:'Evening', openingHours:'20:00-03:00', bookingTimes:['20:00', '21:00', '22:00'], minGuests:2, maxGuests:10, insider_tip:'Book the dinner package. The show is the main event. Dress to impress.' },
  { id:'club-009', category:'clubs', name:'O Beach — Pool Party', subtitle:'Wild pool party · San Antonio', price:65, unit:'per person'||'per person', emoji:'💦', partner:'O Beach', location:'San Antonio, Ibiza', lat:38.9790, lng:1.3030, highlights:['Acrobatics & confetti shows','Wild atmosphere','Multiple DJs','Great for groups'], popular:true, duration:'Afternoon-evening', openingHours:'10:00-20:00', bookingTimes:['10:00', '11:00', '12:00', '13:00', '14:00', '15:00'], minGuests:2, maxGuests:20, insider_tip:'Saturday afternoons are peak energy. Book a group bed for the best position.' },
  { id:'club-010', category:'clubs', name:'Destino Five — Pool Party', subtitle:'Luxury pool club · Talamanca', price:120, unit:'per person'||'per person', emoji:'🏊', partner:'Destino Five', location:'Talamanca, Ibiza', lat:38.9160, lng:1.4480, highlights:['Mediterranean views','Adults-only luxury','World-class DJs','Elegant atmosphere'], popular:false, duration:'Afternoon-evening', openingHours:'12:00-21:00', bookingTimes:['12:00', '13:00', '14:00', '15:00', '16:00'], minGuests:1, maxGuests:10, insider_tip:'Thursdays host Music On with Marco Carola.' },
  // ── MORE BEACH CLUBS ─────────────────────────────────────────
  ...
  // ── Additional Clubs ─────────────────────────────────────────
  { id:'club-011', category:'clubs', name:'Eden San Antonio — Entry', subtitle:'San Antonio · Superclub · Terrace', price:55, unit:'per person', emoji:'🌿', partner:'Eden Ibiza', location:'C/ Salvador Espriu, San Antonio', lat:38.9784, lng:1.3010, highlights:['Legendary San Antonio superclub','Massive main room + terrace','Resident DJs all summer','18+ only'], popular:true, duration:'All night', minGuests:1, maxGuests:20, openingHours:'midnight-06:00', bookingTimes:['23:00','00:00','01:00','02:00'], insider_tip:'The terrace is one of the best in Ibiza — get there before 1am for the best spot.' },
  { id:'club-012', category:'clubs', name:'Es Paradis — Entry', subtitle:'San Antonio · Temple of music', price:50, unit:'per person', emoji:'🏛️', partner:'Es Paradis', location:'C/ Salvador Espriu 2, San Antonio', lat:38.9790, lng:1.3014, highlights:['Iconic pyramid architecture','Famous water parties Wednesdays','Classical and electronic music','Running since 1975'], popular:false, duration:'All night', minGuests:1, maxGuests:20, openingHours:'midnight-06:00', bookingTimes:['23:00','00:00','01:00','02:00'], insider_tip:'Wednesday Water Party is unmissable — they flood the dancefloor. Bring a change of clothes.' },
  { id:'club-013', category:'clubs', name:'Privilege — Entry', subtitle:"World's largest nightclub · San Rafael", price:70, unit:'per person', emoji:'👑', partner:'Privilege Ibiza', location:'Carretera Ibiza-San Antonio, San Rafael', lat:38.9678, lng:1.3712, highlights:["World's largest club capacity 10,000","Iconic pool inside the venue","Host to Manumission legends","Multiple rooms and terraces"], popular:false, duration:'All night', minGuests:1, maxGuests:30, openingHours:'midnight-06:00', bookingTimes:['23:00','00:00','01:00','02:00'], insider_tip:'The sheer scale is breathtaking. Main room gets going around 2am.' },
  { id:'club-014', category:'clubs', name:'Heart Ibiza — Show & Club', subtitle:'Ibiza Town · Alchemist experience', price:165, unit:'per person', emoji:'❤️', partner:'Heart Ibiza', location:'Marina de Ibiza, Ibiza Town', lat:38.9052, lng:1.4418, highlights:['Cirque du Soleil inspired show','El Bulli team curated food','Art + music + gastronomy fusion','Unique Ibiza experience'], popular:true, duration:'20:00-04:00', minGuests:1, maxGuests:10, openingHours:'20:00-04:00', bookingTimes:['20:00','21:00','22:00','23:00'], insider_tip:'Book the dinner package — the show begins before midnight and the food is exceptional.' },
  { id:'club-015', category:'clubs', name:'Ibiza Rocks — Live Music', subtitle:'San Antonio · Pool party & concerts', price:45, unit:'per person', emoji:'🎸', partner:'Ibiza Rocks Hotel', location:'C/ Cervantes 27, San Antonio', lat:38.9801, lng:1.2998, highlights:['Live bands and DJs poolside','International headline acts','Legendary pool party atmosphere','Bar and hotel access'], popular:true, duration:'18:00-00:00', minGuests:1, maxGuests:20, openingHours:'18:00-00:00', bookingTimes:['17:00','18:00','19:00','20:00','21:00'], insider_tip:'Check the lineup in advance — some shows sell out weeks ahead.' },
,
    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 600, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }} onClick={onClose}>
      <div style={{ background: 'linear-gradient(170deg,#0D3545,#1A5060)', borderRadius: '20px 20px 0 0', padding: '24px 20px 40px', width: '100%', maxWidth: 480, maxHeight: '90vh', overflowY: 'auto' }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 4 }}>
          {(service.bookingTimes || ['09:00','10:00','11:00','12:00','13:00','14:00','15:00','16:00','17:00','18:00','19:00','20:00','21:00','22:00']).map(slot => (
