...
// Pre-baked Spanish translations — works without any API call
const UI_STRINGS_ES = {
  "home": "Inicio",
  "search": "Buscar",
  "basket": "Cesta",
  ...
  "anytime": "En cualquier momento. En cualquier lugar. Ibiza.",
  "welcomeWhiteIsle": "Bienvenido a la Isla Blanca",
  "searchPlaceholder": "Pregunta a Isla lo que quieras — día de playa, noche de cócteles...",
  "searchResults": "Resultados",
  "noResults": "Sin resultados — prueba otras palabras",
  "islaSearching": "Isla está buscando para ti...",
  "askIsla": "Pregunta a Isla IA",
  ...
  "onSale": "En oferta",
  "shopByOccasion": "Compra por ocasión",
  "deliveryAddress": "Introduce tu dirección de entrega",
  "setLocation": "Establece tu ubicación",
  "deliveredIn": "Entregado en",
  "minutes": "min",
  "open247": "Abierto 24/7",
  "freeDelivery": "Entrega gratuita en pedidos superiores a €200",
  "deliveryFee": "Gastos de envío",
  "estimatedTime": "Tiempo estimado",
  "beachDelivery": "Entrega en playa",
  "carDelivery": "Entrega en tu coche",
  "deliverToMyCar": "Entregar en mi coche",
  "whereParked": "Llevamos tu pedido hasta donde está aparcado tu coche",
  "useMyLocation": "Usar mi ubicación actual",
  "describeLocation": "Describe dónde estás aparcado",
  ...
  "ageWarning": "Se requiere DNI +18 en la entrega para alcohol y tabaco",
  "minimumOrder": "Pedido mínimo",
  "addMore": "Añadir más",
  "scheduleOrder": "Programar para más tarde",
  "groupOrder": "Pedido en grupo",
  "continueToCheckout": "Continuar al pago",
  "viewBasket": "Ver cesta",
  "addToCart": "Añadir",
  "addedToBasket": "¡Añadido!",
  "removeItem": "Eliminar",
  "checkout": "Pedir ahora — entrega inmediata",
  "payment": "Pago",
  ...
  "delivered": "Entregado",
  "driverOnWay": "El repartidor está en camino",
  "placeAnotherOrder": "Realizar otro pedido",
  ...
  "loyalty": "Recompensas Isla",
  "earnStamps": "Ganar sellos",
  ...
  "islaInsider": "Consejo exclusivo de Isla",
  "requestSent": "¡Solicitud enviada!",
  "justLanded": "¿Acabas de aterrizar en Ibiza?",
  "justLandedDesc": "Consigue todo lo que necesitas entregado en menos de 30 minutos — bebidas, comida, crema solar y mucho más.",
  "arrivalPackages": "Ver paquetes de llegada",
  "addAllToBasket": "Añadir todo a la cesta",
  "ibizaArrivalPackage": "Paquete de llegada a Ibiza",
  "viewPackage": "Ver paquete",
  "numberOfGuests": "Número de invitados",
  "selectDate": "Seleccionar fecha",
  "whatPlanning": "¿Qué estás planeando?",
  "buildWithAI": "Crear con Isla IA",
  "yourSelection": "Tu selección",
  "addItems": "Añadir artículos a la cesta",
  "spirits": "Licores",
  "champagne": "Champán",
  "wine": "Vino",
  "beerCider": "Cerveza y Sidra",
  ...
  "party": "Fiesta",
  "cocktail": "Cócteles",
  "fresh": "Fresco y Guarnición",
  "all": "Todo",
  "vibePreDrinks": "Copas previas",
  "vibeCocktail": "Noche de cócteles",
  "vibeSundowner": "Sundowner",
  "vibeLadies": "Noche de chicas",
  "vibeBoys": "Noche de chicos",
  "vibeHangover": "Remedio para la resaca",
  "vibeDateNight": "Cena romántica",
  "vibePool": "Fiesta en piscina",
  "vibeGentleman": "Velada de caballeros",
  "vibeBirthday": "Cumpleaños",
  "vibeBeach": "Día de playa",
  "vibeSnacks": "Tabla de snacks",
  "continueShopping": "Seguir comprando",
  "items": "artículos",
  "item": "artículo",
  "shareBasket": "Compartir cesta",
  "scanBarcode": "Escanear código",
  "contactSupport": "Contactar soporte",
  "chatWithUs": "Chatea con nosotros",
  "faq": "Preguntas frecuentes",
  "askingIsla": "Preguntando a Isla...",
  "islaThinking": "Isla está pensando...",
  "couldNotGenerate": "No se pudo generar ahora mismo — por favor inténtalo de nuevo",
  "poolPartyMode": "Modo fiesta en piscina",
  "bulkOrdering": "Pedido masivo para grupos",
  "villaPresets": "Preajustes de villa",
  "loadPreset": "Cargar preajuste",
  "savePreset": "Guardar preajuste",
  "morningAfterKit": "Kit para la mañana siguiente",
  "orderRecovery": "Pedir artículos de recuperación",
...
uiCache['es'] = { ...UI_STRINGS, ...UI_STRINGS_ES }
