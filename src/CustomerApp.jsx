...
function LangSheet({ onClose }) {
  ...
  return (
    <>
      <div
        onClick={onClose}
        style={{ position:'fixed', top:0, left:0, right:0, bottom:0, zIndex:8888, background:'rgba(0,0,0,0.6)' }}
      />
      <div style={{ position:'fixed', left:0, right:0, bottom:0, zIndex:8889, background:'#0D3545', borderRadius:'18px 18px 0 0', paddingBottom:40, maxHeight:'70vh', display:'flex', flexDirection:'column' }}>
        <div style={{ textAlign:'center', padding:'12px 0 0' }}>
          <div style={{ width:32, height:4, background:'rgba(255,255,255,0.25)', borderRadius:2, display:'inline-block' }}/>
        </div>
        <div style={{ fontSize:11, fontWeight:700, color:'rgba(255,255,255,0.4)', textTransform:'uppercase', letterSpacing:'1px', padding:'10px 16px 6px' }}>Select language</div>
...
// Keep old name as alias so call sites work
function LanguagePicker({ onOpen }) {
  return <LangButton onOpen={onOpen} />
}
      ...
      <div style={{ background:C.header }}>
        <div style={{ display:'flex',justifyContent:'space-between',alignItems:'center',padding:'16px 16px 0' }}>
          ...
          <div style={{ display:'flex',gap:7,alignItems:'center' }}>
            ...
            <LangButton onOpen={onOpenLangPicker} />
          </div>
        </div>
